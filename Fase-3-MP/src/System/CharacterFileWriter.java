...
//Hay un problema y es que sobreecribe
    private final String CHARACTER_FILE_PATH = "Fase-3-MP/src/Files/Characters.txt";
    ...
    public void vampireWriter(ArrayList<Client> clientArrayList, int i, Client client) throws IOException {
        ...
        try {
            ...
            FileWriter fw = new FileWriter(file, true); //, true hace que escriba debajo sin borrar a otros.
            BufferedWriter bw = new BufferedWriter(fw);
            writeLine(bw, "========== CHARACTER ==========", "");
            writeLine(bw, "REGISTRO_USUARIO ", client.getRegister()); //para saber de qué usuario es
        writeLine(bw, "TIPO DE PERSONAJE ", character.getType());
        ...
        writeLine(bw, "ORO DISPONIBLE ", String.valueOf(vampire.getGold()));
    ...
    public void licantropWriter(ArrayList<Client> clientArrayList, int i, Client client) throws IOException {
        ...
        bw.write(licantrop.getType()); bw.newLine();
        ...
        bw.write("========== FIN USUARIO =========="); bw.newLine();
        }catch (Exception exception) {
            mainSystem system = new mainSystem();
            system.selector();
            exception.printStackTrace();
    ...
    public void hunterWriter(ArrayList<Client> clientArrayList, int i, Client client) throws IOException {
